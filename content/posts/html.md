...
* [扩展](#扩展)
  ...
  * [IE GET 方式请求数据缓存问题](#ie-get-方式请求数据缓存问题)
  * [如何给 DIV 添加onblur事件](#如何给-div-添加onblur事件)
    * [div添加onblur事件](#div添加onblur事件)
    * [focus状态样式变化](#focus状态样式变化)
    * [div内包含其他可以focus的元素的情况(如果是内部的元素导致的onblur不进行操作)](#div内包含其他可以focus的元素的情况如果是内部的元素导致的onblur不进行操作)
    * [获取焦点元素的浏览器兼容问题(IE坑爹)](#获取焦点元素的浏览器兼容问题ie坑爹)
* [参考](#参考)

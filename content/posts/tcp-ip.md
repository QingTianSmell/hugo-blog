...
DNS（Domain Name System）服务是和 HTTP 协议一样位于应用层的协议。它提供域名到 IP 地址之间的解析服务。计算机既可以被赋予 IP 地址，也可以被赋予主机名和域名。比如 http://www.badidu.com。  
...
[HTTP 协议学习笔记](http://blog.orionpax.top/posts/http/)

#### 协议之间的关系

![协议之间的关系](/img/tcp4.jpg)
